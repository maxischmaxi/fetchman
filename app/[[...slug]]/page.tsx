...
export default function WorkspacePage() {
  ...
  const navigateToRequest = useCallback(
    async (requestId: string) => {
      try {
        ...
        const segments = [resolvedWorkspaceId, ...folderSegments, requestId].filter(Boolean)
  ...
  const navigateToWorkspace = useCallback(
    (workspaceId: string) => {
      ...
      router.push(search ? `/${workspaceId}?${search}` : `/${workspaceId}`, { scroll: false })
    },
    [router, searchParams],
  )
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 overflow-hidden">
        ...
        {!selectedRequestId && showFolderOverview && activeFolderId && selectedWorkspaceId && (
          <FolderOverview
        ...
        {!selectedRequestId && !showFolderOverview && showWorkspaceEnvironment && selectedWorkspaceId && (
        ...
        {!selectedRequestId && showFolderOverview && (!activeFolderId || !selectedWorkspaceId) && (
          <div className="flex h-full items-center justify-center">
            <div className="text-center space-y-2">
              <h2 className="text-2xl font-bold">Ordner konnte nicht geladen werden</h2>
        ...
        {!selectedRequestId && !showFolderOverview && !showWorkspaceEnvironment && (
          <div className="flex h-full items-center justify-center">
            <div className="text-center space-y-2">
